...
const CARS = [
 ...
 {id:"dirtmod",name:"Short Track Modified", rank:"D", res:40,  cost:300, dur:140, spd:70,  acc:60,  hdl:90,  exp:3, ad:"B", rep:"B",
  apt:{short:"A",mid:"C",ss:"D",road:"C",street:"A"}, paint:true,  unlock:{t:"wins",n:2}},
 ...
 {id:"gen4",   name:"Gen-4 Cup Car",  rank:"A", res:200, cost:900, dur:240, spd:160, acc:150, hdl:155, exp:4, ad:"S", rep:"B",
  apt:{short:"A",mid:"S",ss:"A",road:"A",street:"A"}, paint:true,  unlock:{t:"wins",n:24}},
 ...
 {id:"nextgen",name:"NextGen Cup",    rank:"S", res:400, cost:1200,dur:160, spd:200, acc:180, hdl:190, exp:4, ad:"B", rep:"B",
  apt:{short:"A",mid:"S",ss:"S",road:"S",street:"S"}, paint:true,  unlock:{t:"wins",n:34}},
];
...
const PARTS = [
 ...
 {id:"wing",   name:"Rear Spoiler",    cat:"Aero",   rank:"C", res:50,  cost:80,  fx:{spd:-4,hdl:22},
  desc:"Plants the rear. Costs a little top end.", unlock:{t:"start"}},
 {id:"bigwing",name:"Tall Spoiler",    cat:"Aero",   rank:"B", res:95,  cost:160, fx:{spd:-18,hdl:44},
  desc:"Maximum grip for the tight stuff.", unlock:{t:"wins",n:7}},
...
const TRACKS = [
 ...
 {id:"lakeshore",  n:"Lakeshore Street Race",surf:"street",geo:"street",    mi:2.20, laps:12, fee:28,
 ...
 {id:"harborloop", n:"Harbor Loop",         surf:"street",geo:"streettight",mi:1.60, laps:16, fee:42,
 ...
 {id:"crestline",  n:"Crestline Park",      surf:"road",  geo:"roadlong",  mi:3.10, laps:8, fee:48,
 ...
 {id:"bigbeachrc", n:"Big Beach Road Course",surf:"road", geo:"roadoval",  mi:3.56, laps:8, fee:54,
 ...
 {id:"kairodome",  n:"Retro Dome",          surf:"short", geo:"bowl",      mi:0.75, laps:26, fee:60,
